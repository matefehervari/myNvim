  ...
  config = function()
    ...
    local config = {
      ...
      on_attach = function(_) -- bufnr
        ...
        vnoremap('<leader>hs', function() gitsigns.stage_hunk { vim.fn.line('.'), vim.fn.line('v') } end)
        vnoremap('<leader>hr', function() gitsigns.reset_hunk { vim.fn.line('.'), vim.fn.line('v') } end)
        nnoremap('<leader>hS', gitsigns.stage_buffer)
        ...
        nnoremap('<leader>hd', gitsigns.diffthis)
